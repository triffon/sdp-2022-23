...
TEST_CASE("Разделяне на списък с четен брой елементи на две равни части чрез splitAssign") {
    const size_t N = 10;
    LinkedList<int> l, l2;
    for(int i = 0; i < N; i++)
        l.insertLast(i);
...
TEST_CASE("Разделяне на списък с четен брой елементи на две равни части чрез splitAssign2") {
    const size_t N = 10;
    LinkedList<int> l, l2;
    for(int i = 0; i < N; i++)
        l.insertLast(i);
...
TEST_CASE("Разделяне на списък с нечетен брой елементи на две равни части чрез splitAssign2") {
    const size_t N = 11;
    LinkedList<int> l, l2;
    for(int i = 0; i < N; i++)
        l.insertLast(i);
